...
InfiniteTap은 **블루투스 기반 스위치 제어(Switch Control)** 기능을 지원하는 다양한 기기(Vision Pro, iPad, iPhone, macOS, Android 등)와 연동하기 위한
...
3. 기기의 `Switch Control` 설정으로 이동합니다.
4. 해당 입력을 스위치로 등록합니다.
5. 원하는 동작을 매핑합니다.
...
다음 단계로는 자동 재연결 튜닝, 다양한 기기에서의 실기 검증, 조립 사진/회로도 보강 등이 이어질 수 있습니다.
